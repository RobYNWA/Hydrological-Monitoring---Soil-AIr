...
import ustruct
import config
from sht31Read import readsht31
import utime
import measureSensors
from measureSensors import measure # JanD
...
app_key = ubinascii.unhexlify('35AA246E869F79C9C63A38D544899B9D')
dev_eui = ubinascii.unhexlify('70B3D57ED00518C5')
...
# Measure the sensors
batteryVoltage,airTempCelsius,airRelHumidity,kPa1,soilTempCelsius,temperatureC,pressurehPa,relHumidity=measure(messageNumber)
...
airTempCentigradeCelsius=int(airTempCelsius*100+0.5)
airRelHumiditytypermil=int(airRelHumidity*100+0.5)
...
payload=ustruct.pack(">HhhhhhhI",messageNumber,batmV,hPa1,soilTempCentigradeCelsius,airTempCentigradeCelsius,airRelHumiditytypermil,TempCentigrade,unixtimesecs)
