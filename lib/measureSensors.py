...
def measure(messageNumber):
    ...
    try:
        ...
        f.write('{:11d},{:8.3f},{:7.1f},{:6.3f},{:6.3f},{:7.1f},{:7.1f},{:7.1f},{:10d})\n'.format(utime.time(),batteryVoltage,soilTempCelsius,wm1kohm,kPa1,temperatureC,pressurehPa,relHumidity,messageNumber))  # write data to file
    ...
    time.sleep(0.9)  # some waiting time (how long?) needed to ensure data is written to MicroSD and all is closed# Write data to MicroSD memory
    ...
    return(batteryVoltage,airTempCelsius,airRelHumidity,kPa1,soilTempCelsius,temperatureC,pressurehPa,relHumidity)
